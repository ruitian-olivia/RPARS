...
<html lang="en">
<head>
<title>Browse Ribosome Protein</title>
...
<body>
								...
								<ul class="nav navbar-nav">
									...
									<li ><a class="active" href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Browse<span class="caret"></span></a>
										<ul class="dropdown-menu">
											<li><a class="active" class="hvr-bounce-to-bottom" href="ribosomalProtein.php">Ribosomal Protein</a></li>
  ...
  $sql1 = "select count(*) from `ribosomal protein`";
  ...
  $pre = ($pageNow-1)*$pageSize;
			...
			$sql2 ="select * from `ribosomal protein`limit $pre,$pageSize"; //SQL语句
			...
			if($pageNow>1){
			  ...
			  if($pageNow<$pageCount){
				$nextPage = $pageNow+1;
				echo "<a href='ribosomalProtein.php?pageNow=$nextPage'>next</a> ";
				echo "Current page {$pageNow}/Total {$pageCount} pages";
			  }
			  echo "<br/><br/>";
			  ?>
			  
			  <form action="ribosomalProtein.php">
